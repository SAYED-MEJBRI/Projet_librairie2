...
<head>
<meta charset="UTF-8">
<title>Fianliser la modification  d'un livre</title>
</head>
<body>
<h1>Fianliser la modification d'un livre</h1>
<p>
<%
...
update livre_tb set	 titre_livre=?, theme_livre=?, nbr_pages_livre=?, nom_auteur=?, editeur=?, prix_vente=? where isbn="${isbn1}";
